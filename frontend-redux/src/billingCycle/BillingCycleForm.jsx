...
const reduxBillingCycleForm = reduxForm({ form: BILLING_CYCLE_FORM, destroyOnUnmount: false })(BillingCycleForm);
...
export default connect(mapStateToProps, mapDispatchToProps)(reduxBillingCycleForm);
